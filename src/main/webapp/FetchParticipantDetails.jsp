...
<body>
    <div class="center">
        ...
        <% } else { %>
            <p><strong>Participant Current Details:</strong></p>
        ...
        <form action="UpdateParticipant" method="post">
            ...
            <br>
            <!-- Display participant current details for modification -->
            ...
            <br> <label for="batchname">Batch Name: </label><br> <select
                ...
                <option value="DallasZumba">Dallas Zumba</option>
                <option value="DFWZumba">DFW Zumba</option>
